...
enum Country: string
{
	...
	public function demonym(): string
	{
		return match($this) {
			...
			static::AE => 'Emirian',
			static::AF => 'Afghan',
			static::AG => 'Antiguan / Barbudan',
			static::AI => 'Anguillan',
			static::AL => 'Albanian',
			static::AM => 'Armenian',
			static::AO => 'Angolan',
			static::AQ => 'Antarctican',
			static::AR => 'Argentinean',
			static::AS => 'American Samoan',
			static::AT => 'Austrian',
			static::AU => 'Australian',
			static::AX => 'Ålandic',
			static::AW => 'Aruban',
			static::AZ => 'Azerbaijani',
			static::BA => 'Bosnian / Herzegovinian',
			static::BB => 'Barbadian',
			static::BD => 'Bangladeshi',
			static::BE => 'Belgian',
			static::BF => 'Burkinabe',
			static::BG => 'Bulgarian',
			static::BH => 'Bahraini',
			...
			static::BV => 'Bouvet Island',
			static::BW => 'Botswana',
			static::BY => 'Belarusian',
			static::BZ => 'Belizean',
			static::CA => 'Canadian',
			static::CC => 'Cocos (Keeling) Islands',
			static::CD => 'Congolese',
			static::CF => 'Central African',
			static::CG => 'Congolese',
			static::CH => 'Swiss',
			static::CI => 'Ivoirian',
			static::CK => 'Cook Islands',
			static::CL => 'Chilean',
			static::CM => 'Cameroonian',
			static::CN => 'Chinese',
			static::CO => 'Colombian',
			static::CR => 'Costa Rican',
			static::CU => 'Cuban',
			static::CV => 'Cape Verdean',
			static::CX => 'Christmas Island',
			static::CY => 'Cypriot',
			static::CZ => 'Czech',
			static::DE => 'German',
			...
			static::DO => 'Dominican',
			static::DZ => 'Algerian',
			static::EC => 'Ecuadorean',
			static::EE => 'Estonian',
			static::EG => 'Egyptian',
			static::EH => 'Western Saharan',
			static::ER => 'Eritrean',
			static::ES => 'Spanish',
			static::ET => 'Ethiopian',
			static::FI => 'Finnish',
			static::FJ => 'Fijian',
			static::FK => 'Falkland Islands',
			...
			static::GD => 'Grenadian',
			static::GE => 'Georgian',
			static::GF => 'French Guianan',
			static::GH => 'Ghanaian',
			static::GI => 'Gibraltan',
			static::GL => 'Greenlandic',
			static::GM => 'Gambian',
			static::GN => 'Guinean',
			static::GP => 'Guadeloupe',
			static::GQ => 'Equatoguinean',
			static::GR => 'Greek',
			static::GS => 'South Georgia',
			static::GT => 'Guatemalan',
			static::GU => 'Guamanian',
			static::GW => 'Guinea-Bissauan',
			static::GY => 'Guyanese',
			static::HK => 'Hongkongese',
			static::HM => 'Heard and Mc Donald Islands',
			static::HN => 'Honduran',
			static::HR => 'Croatian',
			static::HT => 'Haitian',
			static::HU => 'Hungarian',
			static::ID => 'Indonesian',
			static::IE => 'Irish',
			static::IL => 'Israeli',
			static::IN => 'Indian',
			static::IO => 'British Indian Ocean Territory',
			...
			static::JP => 'Japanese',
			static::KE => 'Kenyan',
			static::KG => 'Kyrgyzstani',
			static::KH => 'Cambodian',
			static::KI => 'I-Kiribati',
			static::KM => 'Comoran',
			static::KN => 'Kittian and Nevisian',
			static::KP => 'North Korean',
			static::KR => 'South Korean',
			static::KW => 'Kuwaiti',
			static::KY => 'Cayman Islands',
			static::KZ => 'Kazakhstani',
			static::LA => 'Laotian',
			static::LB => 'Lebanese',
			static::LC => 'Saint Lucian',
			static::LI => 'Liechtensteiner',
			static::LK => 'Sri Lankan',
			static::LR => 'Liberian',
			static::LS => 'Basotho',
			static::LT => 'Lithuanian',
			static::LU => 'Luxembourger',
			static::LV => 'Latvian',
			static::LY => 'Libyan',
			static::MA => 'Moroccan',
			static::MC => 'Monégasque',
			static::MD => 'Moldova, Republic of',
			static::ME => 'Montenegrin',
			static::MG => 'Malagasy',
			static::MH => 'Marshallese',
			static::MK => 'Macedonian',
			static::ML => 'Malian',
			static::MM => 'Myanmarese',
			static::MN => 'Mongolian',
			static::MO => 'Macau',
			static::MP => 'Northern Mariana Islands',
			static::MQ => 'Martinican',
			static::MR => 'Mauritanian',
			static::MS => 'Montserrat',
			static::MT => 'Maltese',
			static::MU => 'Mauritian',
			static::MV => 'Maldivan',
			...
			static::MX => 'Mexican',
			static::MY => 'Malaysian',
			static::MZ => 'Mozambican',
			static::NA => 'Namibian',
			static::NC => 'New Caledonia',
			static::NE => 'Nigerien',
			static::NF => 'Norfolk Island',
			static::NG => 'Nigerian',
			static::NI => 'Nicaraguan',
			static::NL => 'Dutch',
			static::NO => 'Norwegian',
			static::NP => 'Nepalese',
			static::NR => 'Nauruan',
			...
			static::NZ => 'New Zealand',
			static::OM => 'Omani',
			static::PA => 'Panamanian',
			static::PE => 'Peruvian',
			static::PF => 'French Polynesian',
			static::PG => 'Papua New Guinean',
			static::PH => 'Filipino',
			static::PK => 'Pakistani',
			static::PL => 'Polish',
			static::PM => 'St. Pierre and Miquelon',
			static::PN => 'Pitcairn',
			static::PR => 'Puerto Rican',
			static::PS => 'Palestinian',
			static::PT => 'Portuguese',
			static::PW => 'Palauan',
			static::PY => 'Paraguayan',
			static::QA => 'Qatari',
			static::RE => 'Reunion',
			static::RO => 'Romanian',
			static::RS => 'Serbian',
			...
			static::RW => 'Rwandan',
			static::SA => 'Saudi',
			static::SB => 'Solomon Islander',
			static::SC => 'Seychellois',
			static::SD => 'Sudanese',
			static::SE => 'Swedish',
			static::SG => 'Singaporean',
			static::SH => 'St. Helena',
			static::SI => 'Slovene',
			static::SK => 'Slovak',
			static::SL => 'Sierra Leonean',
			static::SM => 'Sammarinese',
			static::SN => 'Senegalese',
			static::SO => 'Somali',
			static::SR => 'Surinamer',
			static::SS => 'Sudanese',
			static::ST => 'Sao Tomean',
			static::SV => 'Salvadoran',
			static::SX => 'Sint Maartener',
			static::SY => 'Syrian Arab Republic',
			static::SZ => 'Swazi',
			static::TC => 'Turks and Caicos Islands',
			static::TD => 'Chadian',
			static::TF => 'French Southern Territories',
			static::TG => 'Togolese',
			static::TH => 'Thai',
			static::TJ => 'Tajikistani',
			static::TK => 'Tokelauan',
			static::TL => 'East Timorese',
			static::TM => 'Turkmen',
			static::TN => 'Tunisian',
			static::TO => 'Tongan',
			static::TR => 'Turkish',
			static::TT => 'Trinidadian / Tobagonian',
			static::TV => 'Tuvaluan',
			static::TW => 'Taiwanese',
			static::TZ => 'Tanzanian',
			static::UA => 'Ukrainian',
			static::UG => 'Ugandan',
			static::UM => 'American Islander',
			static::US => 'American',
			static::UY => 'Uruguayan',
			static::UZ => 'Uzbek',
			static::VA => 'Vatican City State (Holy See)',
			static::VC => 'Saint Vincent and the Grenadines',
			static::VE => 'Venezuelan',
			static::VG => 'Virgin Islands (British)',
			static::VI => 'Virgin Islands (U.S.)',
			static::VN => 'Vietnamese',
			static::VU => 'Ni-Vanuatu',
			static::WF => 'Wallis and Futuna Islands',
			static::WS => 'Samoan',
			static::XK => 'Kosovan',
			static::YE => 'Yemeni',
			static::YT => 'Mahoran',
			static::ZA => 'South African',
			static::ZM => 'Zambian',
			static::ZW => 'Zimbabwean',
			default => $this->label()
		};
	}
